...
namespace
{
    ...
    // Shared normalized breakpoint positions for the 12 shaper presets.
    // Keeping the coordinates in one place ensures preset application and
    // thumbnail rendering stay perfectly synchronized.
    constexpr std::array<float, HomeSidechainReceiverAudioProcessor::maxNodes> defaultNodeX =
        { 0.00f, 0.12f, 0.25f, 0.40f, 0.55f, 0.70f, 0.85f, 1.00f };

    constexpr std::array<std::array<float, HomeSidechainReceiverAudioProcessor::maxNodes>, 12> presetY = {{
        { 1.00f, 1.00f, 1.00f, 1.00f, 1.00f, 1.00f, 1.00f, 1.00f },
        { 0.02f, 0.92f, 0.96f, 0.96f, 0.96f, 0.96f, 0.98f, 1.00f },
        { 0.02f, 0.72f, 0.96f, 0.96f, 0.96f, 0.96f, 0.98f, 1.00f },
        { 1.00f, 0.94f, 0.76f, 0.52f, 0.30f, 0.16f, 0.08f, 0.02f },
        { 1.00f, 0.96f, 0.72f, 0.40f, 0.24f, 0.18f, 0.12f, 0.08f },
        { 1.00f, 0.82f, 0.48f, 0.30f, 0.18f, 0.12f, 0.08f, 0.06f },
        { 1.00f, 0.98f, 0.92f, 0.84f, 0.62f, 0.30f, 0.08f, 0.04f },
        { 1.00f, 0.98f, 0.88f, 0.54f, 0.26f, 0.12f, 0.06f, 0.02f },
        { 1.00f, 0.76f, 0.40f, 0.22f, 0.12f, 0.08f, 0.04f, 0.02f },
        { 1.00f, 0.64f, 0.54f, 0.44f, 0.34f, 0.24f, 0.14f, 0.06f },
        { 1.00f, 0.92f, 0.82f, 0.70f, 0.56f, 0.42f, 0.28f, 0.14f },
        { 1.00f, 0.52f, 0.20f, 0.12f, 0.18f, 0.34f, 0.68f, 0.96f }
    }};
